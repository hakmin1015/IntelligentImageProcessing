...
% Interpolate values for x = 127 to 135 based on average filter
filterSize = 5; % Adjust the size of the average filter
interpolatedValues = conv(hist(12:136), ones(1, filterSize) / filterSize, 'valid');
hist(127:135) = interpolatedValues;
